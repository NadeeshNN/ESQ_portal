...
import { CInputGroup, CInputGroupText, CRow, CSelect } from "@coreui/react";
...
export default function Qt_SelectedTable(props) {
  ...
  // const StyledAlerts = styled(Alert)(({ theme }) => ({
  //   display: "float",
  //   top: theme.spacing(2),
  //   left: "50%",
  //   top: -50,
  ...
  useEffect(() => {
    ...
    if (newItems && Array.isArray(selectedProducttableData)) {
      const shouldAddItems = newItems.filter((newItem) => {
        ...
        if (itemExists) {
          // <Stack sx={{ width: "100%", zIndex: 9999 }} spacing={2}>
  ...
  const getSelectedProducttableData = () => {
    ...
    fetch(`${API_URL}quotation/getquotedetails?quoteno=${quoteno}`, {
      ...
      .then((data) => {
        ...
        const results = datar[0].ResultSet;
        console.log("datar", results);
        const msg = datar[0].ReturnMessage;
        const msg1 = msg[0] || "";
        const msg2 = msg[1] || "";
        if (msg1 !== "") {
          setAlertTitle("Notify");
        ...
        setSelectedProducttableData(results);
  ...
  const changeProductProfit = (
    ...
    //const Value = Product_sell - productTotal;
    // setMargin(Value);
        ...
        <table class="tableQt-ProductTable">
          ...
          >
            <tr>
              ...
              <th style={{ width: "90px" }}>Quarry No</th>
              <th style={{ width: "100px" }}>Product Code</th>
              <th style={{ width: "80px" }}>Truck Type</th>
              ...
              <th style={{ width: "100px" }}>Grand Total Exc</th>
              <th style={{ width: "100px" }}>Grand Total Cost</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* {editedProductProfit !== "" &&
                        editedProductProfitIndex === index
                          ? editedProductProfit
                          : item &&
                            item.Product_sell &&
                            item.Product_cost &&

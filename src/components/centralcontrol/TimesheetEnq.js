          ...
          <PeerTable2
            ...
            columns={[
              ...
              },
              {
                ...
                renderCell: (params) => (
                  <button
                  //className="text-black-600 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-1 py-0.2 me-0 mb-0 dark:bg-gray-400 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-600"
              ...
              },
              {
                ...
                renderCell: (params) => (
                  ...
                  <button
                 // className="text-black-600 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:ring-gray-100 font-small rounded-lg text-sm px-0.3 py-0.2 me-0 mb-0 dark:bg-gray-400 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-600"
                    className="breakInB2"
                    variant="contained"
                    color="primary"
                    size="small"
...

              {
                ...
                renderCell: (params) => (
                  <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                  <button  
                 // className="text-gray-600 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-1 py-0.2 me-0 mb-0 dark:bg-gray-400 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-600"
